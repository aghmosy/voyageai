...
async function generateItinerary(trip, settings) {
  ...
  const result = await complete({
    ...
    messages: [
      {
        role: 'user',
        content: `Please create a detailed ${inputs.duration}-day itinerary for ${destination.country} visiting ${destination.cities.join(', ')}. Include restaurant recommendations with source links.`,
      },
    ],
    tools,
